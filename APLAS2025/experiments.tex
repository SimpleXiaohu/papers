...
As aforementioned, for the constraints in $\seqext\mbox{\sf -M}$, we do not generate string constraints or compare against cvc5, Z3, Z3-noodler and $\ostrich$, as they cannot be expressed using only the basic operations of string theory.
