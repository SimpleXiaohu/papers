...
String constraint solving has received considerable attentions in literature. Amadini \cite{Amadini23} provides a comprehensive survey for the literature up to 2021. In particular, %extensive documentation of this diversity, and classifies
...
and to handle string operations, e.g., \cite{Abdulla14,HJLRV18,CCH+18,Vijay-length,LB16,BerzishKMMDNG20,ChenCHHLS24}), word-based (algebraic approaches based on systems of word equations%They mainly use SMT solvers to tackle string constraints
, e.g., \cite{cvc4,BarbosaBBKLMMMN22,Z3,Z3str2,Z3str3,Z3str4,TCJ16,S3,BerzishKMMDNG20,ChenCHHLS24} 
), 
...
%Generally speaking, 
From another perspective, there are two lines of work aiming for building %Approaches to building 
...
\noindent
{\bf Theory of arrays.}
There are many studies on solving formulas in the theory of arrays or its extensions, for instance, \cite{SBDL01,BMS06,HIV08,FalkeMS13,DacaHK16,FarinierDBL18}, which are also related to the sequence theory. Note that in these studies, the elements are considered to be either of a generic type or of integer type. In other words, theory of arrays where the elements are of the string type has not been defined and investigated therein. 
