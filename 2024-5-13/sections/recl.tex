...
\hdh{(1) }$\varphi \equiv x \in \regex$ and $\theta(x) \in \Lang(\regex)$, 
%
\hdh{(2) }$\varphi \equiv t_1\ \op\ t_2$ and $\theta(t_1)\ \op\ \theta(t_2)$, 
%
\hdh{(3) }$\varphi \equiv \varphi_1 \wedge \varphi_2$ and $\theta \models \varphi_1$ and $\theta \models \varphi_2$.
