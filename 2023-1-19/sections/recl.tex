...
\end{itemize}
A RECL formula $\varphi$ is said to be satisfiable if there is a mapping $\theta$ such that $\theta \models \varphi$. The satisfiability problem for RECL is to decide whether a given RECL formula $\varphi$ is satisfiable. 
