...
As a result, satisfiability of string constraints with regex-counting and string-length is reduced to satisfiability of linear integer arithmetic, which can then be solved by off the shelf SMT solvers. 
%
...
\keywords{Regex Expressions, Counting, Length, Automata, Registers, Linear Integer Arithmetic}
%\end{document}