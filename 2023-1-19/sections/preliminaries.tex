...
Moreover, the class of regular languages is closed under union, intersection, concatenation, Kleene star, complement, and language difference \cite{HU79}.  In the sequel, we recall the constructions of NFA corresponding to these language operations. Let $\NFA_1 = (Q_1, \Sigma, \delta_1, q_{1,0}, F_1)$ and $\NFA_2 = (Q_2, \Sigma, \delta_2, q_{2,0}, F_2)$ be two NFA such that $Q_1 \cap Q_2 = \emptyset$. 
\begin{itemize}
\item The union of $\NFA_1$ and $\NFA_2$, denoted by $\NFA_1 \cup \NFA_2$, is defined as the tuple $(Q', \Sigma, \delta', q'_0, F')$, where $Q'= Q_1 \cup Q_2 \cup \{q'_0\}$ with $q'_0 \not \in Q_1 \cup Q_2$, $\delta' = \delta_1 \cup \delta_2 \cup \{(q'_0, a, q') \mid (q_{1,0}, a, q') \in \delta_1\} \cup \{(q'_0, a, q') \mid (q_{2,0}, a, q') \in \delta_2\}$, $F'=F_1 \cup F_2$. 
%
\item The intersection of $\NFA_1$ and $\NFA_2$, denoted by $\NFA_1 \cap \NFA_2$, is defined as the tuple $(Q', \Sigma, \delta', q'_0, F')$, where $Q' = Q_1 \times Q_2$, $q'_0 = (q_{1,0}, q_{2,0})$, $F' = F_1 \times F_2$, $\delta' = \{((q_1, q_2), a, (q'_1, q'_2)) \mid (q_1, a, q'_1) \in \delta_1, (q_2, a, q'_2) \in \delta_2\}$.
%
\item The concatenation of $\NFA_1$ and $\NFA_2$, denoted by $\NFA_1 \concat \NFA_2$, is defined as the tuple $(Q', \Sigma, \delta', q'_0, F')$, where $Q' = Q_1 \cup Q_2$, $q'_0 = q_{1,0}$, $\delta' = \delta_1 \cup \delta_2 \cup \{(q_1, a, q_2) \mid q_1 \in F_1, (q_{2,0}, a, q_2) \in \delta_2\}$, moreover, if $q_{2,0} \in F_2$, then $F'= F_1 \cup F_2$, otherwise, $F'= F_2$.
%
\item The Kleene star of $\NFA_1$, denoted by $\NFA_1^*$, is defined as $(Q_1, \Sigma, \delta'_1, q_{1,0}, F'_1)$, where $\delta'_1 = \delta_1 \cup \{(q_1, a, q'_1) \mid q_1 \in F_1, (q_{1,0}, a, q'_1) \in \delta_1\}$, $F'_1= F_1 \cup \{q_{1,0}\}$.
%
\item The complement of $\NFA_1$, denoted by $\overline{\NFA_1}$, is defined as $(Q'_1, \Sigma, \delta'_1, \{q_{1,0}\}, Q'_1 \setminus F'_1)$, where  $(Q'_1, \Sigma, \delta'_1, \{q_{1,0}\}, F'_1)$ is the DFA obtained from $\NFA_1$ by subset construction.  
%
\item The language difference of $\NFA_1$ and $\NFA_2$, denoted by $\NFA_1 \setminus \NFA_2$, is defined as $\NFA_1 \times \overline{\NFA_2}$.
\end{itemize}
