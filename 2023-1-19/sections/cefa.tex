...
The definition of CEFA below is slightly different from the definition in~\cite{atva2020} in the sense that accepting conditions on register values
%specified by LIA formulas
%, where the free variables are the registers, 
