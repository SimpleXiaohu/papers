...
Let $e$ be a regular expression and $(e')^{\{m,n\}}$ be an occurrence of the counting operators in $e$. Then $(e')^{\{m,n\}}$ is said to be \emph{persistent} in $e$ if  $(e')^{\{m,n\}}$ is not in the scope of a complement, Kleene star, or counting operator in $e$. 
